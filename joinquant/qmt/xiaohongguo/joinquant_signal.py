# 克隆自聚宽文章：https://www.joinquant.com/post/57633
# 标题：小红果策略微调（年化177%，回撤15.79%）
# 作者：ssabr
...
import xiaohongguo_sql

# ⭐ 在这里设置这个策略的分类标签（写入 trade.fenlei）
xiaohongguo_sql.FENLEI = '小红果'      # 或 '中长线趋势策略B' 等

from xiaohongguo_sql import (
    order_zzy as order,
